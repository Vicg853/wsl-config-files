...
export ZSH="/home/vicg853/.oh-my-zsh"
...
plugins=(git docker zsh-autosuggestions zsh-completions fast-syntax-highlighting)
...
## Enabing mouse support
export ENABLE_VIRTUAL_TERMINAL_INPUT=true
...
mkenter() {
	#Create a new directory and get inside of it just after
    mkdir "$1"
    cd "$1"
}
cdl(){
	#Access a directory and list content just after it
	cd "$1"
	ls -a
}
alias clean="clear && cd ~ && neofetch"


#Export removing windows's npm and adding wsl2s yarn path instead
